...
module.exports = function(gulp) {
  ...
  /* Release */
  gulp.task('init distributions', 'Grabs each homeComponent from GitHub', initDistributions);
  gulp.task('create distributions', 'Updates files in each repo', createDistributions);
  gulp.task('init components', 'Grabs each homeComponent from GitHub', initComponents);
  gulp.task('create components', 'Updates files in each repo', createComponents);

  /* Publish */
  gulp.task('update distributions', 'Commits homeComponent updates from create to GitHub', updateDistributions);
  gulp.task('update components', 'Commits homeComponent updates from create to GitHub', updateComponents);

...
/*
 This will create individual homeComponent repositories for each SUI homeComponent
    ...
    (function(component) {
      ...
      gulp.task(task.package, false, function() {
        return gulp.src(release.templates.package)
          ...
          .pipe(jsonEditor(function(npm) {
            ...
            npm.description = 'Single homeComponent release of ' + component;
            npm.repository  = {
              type : 'git',
              url  : gitURL
            };
      ...
      gulp.task(task.composer, false, function() {
        return gulp.src(release.templates.composer)
          ...
          .pipe(jsonEditor(function(composer) {
            ...
            composer.description = 'Single homeComponent release of ' + component;
            return composer;
          }))
          .pipe(gulp.dest(outputDirectory))
        ;
      ...
      gulp.task(task.notes, false, function() {
        return gulp.src(release.templates.notes)
          .pipe(plumber())
          .pipe(flatten())
          // Remove release notes for lines not mentioning homeComponent

        ...
        return(
            ...
            <div className="list_all">
                ...
                <div className="list_one width radius">
                    <div className="list_title color_orange font_weight font18 overflow">
                        【尘烟滚滚 风沙走石 ，风里雨里 多彩生机--19天纳米比亚4*4、南非自驾】
                    </div>
                    <div className="list_content color_grey overflow">
                    ...
                    <div className="list_picture overflow">
                        <img src={img1}/>
                        <img src={img2}/>
                    </div>
                    <div className="list_time color_grey overflow">
                        2015-7-4 13:23
                    </div>
                </div>
